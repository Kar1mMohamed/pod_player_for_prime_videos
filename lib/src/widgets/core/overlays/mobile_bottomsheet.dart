part of 'package:pod_player_for_prime_videos/src/pod_player.dart';
    ...
    return GetBuilder<PodGetXVideoController>(
      ...
      builder: (podCtr) => Column(
        ...
        children: [
          ...
          if (podCtr.primeVideoHandlersUrls.isNotEmpty)
            _bottomSheetTiles(
              title: podCtr.podPlayerLabels.quality,
              icon: Icons.video_settings_rounded,
              ...
              onTap: () {
                ...
                Timer(const Duration(milliseconds: 100), () {
                  showModalBottomSheet<void>(
                    context: context,
                    builder: (context) => SafeArea(
                      child: _VideoQualitySelectorMobPrimeVideo(
                        tag: tag,
                        onTap: null,
                      ),
                    ),
            ...
            .map(
              (e) => ListTile(
                ...
                onTap: () {
                  ...
                  podCtr.changeVideoQuality(quality: e.quality);
                },
              ),
            )
            .toList(),
...
class _VideoQualitySelectorMobPrimeVideo extends StatelessWidget {
  final void Function()? onTap;
  final String tag;

  const _VideoQualitySelectorMobPrimeVideo({
    required this.onTap,
    required this.tag,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: podCtr.primeVideoHandlersUrls.keys
            .map(
              (e) => ListTile(
                title: Text(e),
                onTap: () {
                  onTap != null ? onTap!() : Navigator.of(context).pop();
                  podCtr.changeVideoQuality(primeVideoQuality: e);
                },
              ),
            )
            .toList(),
